const LocaleController = require('../models/LocaleModel');
...
exports.createLocation = (req, res) => {
  ...
  let createLocation = new LocaleController(data.locations.length + 1, street, number, city, country);
...
exports.updateLocation = (req, res) => {
  ...
  if (locationIndex > -1) {
    data.locations[locationIndex] = new LocaleController(id, street, number, city, country);
